...
environ.Env.read_env(os.path.join(BASE_DIR, ".env"))  # noqa: PTH118
...
ALLOWED_HOSTS = ["0.0.0.0", "backend", "localhost"]  # noqa: S104
...
DADOS_DIR = BASE_DIR / "/var/data"
DADOS = DADOS_DIR / env.str("DADOS")
